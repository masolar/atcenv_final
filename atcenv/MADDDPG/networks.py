...
from tensorflow.keras.initializers import random_uniform, random_normal, glorot_normal
...
class Actor(tf.keras.Model):
    def __init__(self, name):
        ...
        self.dense_0 = Dense(self.hidden_0, activation='relu',kernel_initializer= glorot_normal())
        self.dense_1 = Dense(self.hidden_1, activation='relu',kernel_initializer= glorot_normal())
        self.policy_1 = Dense(1, activation='tanh',kernel_initializer= glorot_normal()) 
        self.policy_2 = Dense(1, activation='sigmoid',kernel_initializer= glorot_normal()) 
