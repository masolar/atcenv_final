...
class MaSacAgent:
    def __init__(self):
        try:
            ...
            print('DEVICE USED: ', torch.cuda.device(
    ...
    def save_models(self, e):
        ...
        ), "./results/models/actor"+str(e)+".pt")
        torch.save(self.critic.state_dict(
        ), "./results/models/critic"+str(e)+".pt")
    ...
    def load_models(self, e):
        ...
        self.actor.load_state_dict(torch.load(
            ROOT_DIR + "./results/models/actor"+str(e)+".pt", map_location=torch.device('cpu')))
        self.critic.load_state_dict(torch.load(
            ROOT_DIR + "./results/models/critic"+str(e)+".pt", map_location=torch.device('cpu')))
